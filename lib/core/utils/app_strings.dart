...
<<<<<<< Updated upstream
  ...
  //!Bazar
  bazar = "Bazar", historyBooks = "History Books", historicalSouvenirs = "Historical Souvenirs",
  //!Cart
...
=======
  ...
  change = "Change", items = "1 items", 
  selectedProduct = "Selected Product", 
  paymentMethod = "Payment Method", 
  confirmPayment = "Confirm Payment", 
  orderSuccess = "Order Success", 
  thankYou = "Thank you for your order here and your package will be sent to your address very quickly and fast good product", backToHome = "Back To Home",
  //!Forgot password
